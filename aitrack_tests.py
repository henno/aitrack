...
check("praktikapäeviku fallback ei kuva toorprompti ega üldist Praktika-prefiksit objektina", "aitrack uuenda" not in plain["objekt"] and not plain["objekt"].startswith("Praktika -"))
